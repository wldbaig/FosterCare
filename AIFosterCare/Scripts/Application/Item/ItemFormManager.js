...
function ItemFormManager() {
    ...
    this.OnAjaxResponse = function (xhr, status, entityName) {
        ...
        FC.SiteScript.ShowMessage(messageModel);
    ...
    function GetManufactByDistrib(distribId) {
        ...
        var actionUrl = FC.AppConstants.URL.Action.Common.GetDistributorManufacturerList + "?distribId=" + distribId + "&itemId=" + itemId;
